    ...
    async def covid(self, ctx, *, countryName = None):
        try:
            if countryName is None:
                ...
                embed2 = discord.Embed(title=f"**Covid-19 Status Of {country}**!", description="This Information Isn't Always, Hence It May Not Be Accurate!", colour=discord.Colour.random(), timestamp=ctx.message.created_at)
